...
``` bash
cd ~
php -r "copy('https://github.com/acmephp/acmephp/releases/download/1.3.0/acmephp.phar', 'acmephp.phar');"
php -r "copy('https://github.com/acmephp/acmephp/releases/download/1.3.0/acmephp.phar.pubkey', 'acmephp.phar.pubkey');"
